    ...
    <div class="dashboard-header">
        ...
        <div style="display: flex; gap: 15px;">
            @if(Auth::user()->isAdmin())
                <a href="{{ route('admin.dashboard') }}" class="cosmic-btn-sec" style="--user-color: #ffeb3b; border-color: rgba(255, 235, 59, 0.5); color: #ffeb3b; text-decoration: none; display: flex; align-items: center; background: rgba(255, 235, 59, 0.1);">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 1.2rem; height: 1.2rem; margin-right: 8px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                    PANEL DE CONTROL
                </a>
            @endif
